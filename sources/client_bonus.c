...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/17 03:53:02 by rnoriko           #+#    #+#             */
/*   Updated: 2021/10/17 14:06:50 by rnoriko          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char *argv[])
{
	...
	ft_putstr_fd("\033[1m\033[30mMessage received by the server.", STDOUT_FILENO);
	ft_putstr_fd("\033[0m\n", STDOUT_FILENO);
	return (0);
}
